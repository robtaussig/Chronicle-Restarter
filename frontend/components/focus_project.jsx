      ...
      <div>
        ...
        <div onClick={this._goToPage} className="focal-project-wrapper">
          ...
          <div className="focal-right-half">
            <h3 className="focal-project-title">{this.props.project.title === 'null' ? "" : this.props.project.title}</h3>
            <p className="focal-project-username">by <b>{this.state.user}</b></p>
            <br></br>
            <p className="focal-project-blurb">{this.props.project.blurb === 'null' ? "" : this.props.project.blurb}</p>
            <br></br>
            <p className="focal-project-location">{this.props.project.location === 'null' ? "" : this.props.project.location}</p>
            <p className="focal-project-category">{ProjectCategoryIds[this.props.project.category_id === 'null' ? 0 : this.props.project.category_id].label }</p>
            <br></br>
            ...
            <ul className="focal-project-summary">
              <li className="summary-cat">
                <ul className="focal-project-goal">
                  <li id="focal-basic-amount">${this.props.project.goal === 'null' ? 0 : this.props.project.goal}</li>
                  <li id="focal-basic-text">goal</li>
                </ul>
              </li>
              <li className="summary-cat duration-li">
                <ul className="focal-project-duration">
                  <li id="focal-basic-amount">{this.props.project.duration === 'null' ? 0 : this.props.project.duration}</li>
                  <li id="focal-basic-text">days to go</li>
                </ul>
              </li>
              <li className="summary-cat">
                <ul className="focal-project-funders">
                  <li id="focal-basic-amount">{this.props.project.funders === 'null' ? 0 : this.props.project.funders}</li>
