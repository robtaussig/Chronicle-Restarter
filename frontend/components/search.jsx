...
const Search = React.createClass({
  ...
  render () {
    let _display = this.state.searchBar ? [<li className="x-icon">
      <img onClick={this.toggleSearch} id="search-icon" src={window.x_mark}/>
      </li>,<li><input type="text" className="search"
      onChange={this._search} value={this.state.params}/></li>] :
      [<img onClick={this.toggleSearch} id="search-icon" src={window.search}/>];
    return (
